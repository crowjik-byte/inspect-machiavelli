# This file is adapted from https://github.com/aypan17/machiavelli/blob/main/machiavelli/game/player.py
...
from machiavelli.game.types import GameSource, GameSourceLine, GameTreeNode, GameTreeNodeType
...
class Player:
    def __init__(self, game_tree: Mapping[str, GameTreeNode], game_source: GameSource, print_text=False, buffered_print=False, watch_history=False):
